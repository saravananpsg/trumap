...
var validateEnvironmentVariable = function () {
  var environmentFiles = glob.sync('./src/config/env/' + process.env.NODE_ENV + '.js');
  console.log();
...
var validateSessionSecret = function (config, testing) {
  ...
  if (config.sessionSecret === 'iasset') {
    if (!testing) {
...
var initGlobalConfig = function () {
  ...
  var defaultAssets = require(path.join(process.cwd(), 'src/config/assets/default'));

  // Get the current assets
  var environmentAssets = require(path.join(process.cwd(), 'src/config/assets/', process.env.NODE_ENV)) || {};
